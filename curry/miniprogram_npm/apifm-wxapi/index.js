...
module.exports = {
  ...
  queryConfigBatch: function queryConfigBatch(keys) {
    return request('/shop/configById', true, 'get', { tenantId: keys });
  },
  ...
  banners: function banners(data) {
    return request('/shop/banner/list', true, 'get', data);
  },
  ...
  goodsv2: function goodsv2(data) {
    ...
    return request('/goods/list/v2', true, 'post', data);
  },
  ...
  goodsAddition: function goodsAddition(goodsId) {
    return request('/goods/goodsAddition', true, 'get', {
      goodsId: goodsId
    });
  },
  ...
  shippingCarInfo: function shippingCarInfo(token) {
    return request('/shop/cart/info', true, 'get', {
      token: token
    });
  },
  ...
  cyTableAddOrder: function cyTableAddOrder(data) {
    return request('/shopping-cart/add-order', true, 'post', data);
  },
  ...
  goodsTimesSchedule: function goodsTimesSchedule() {
    ...
    return request('/goods/times/schedule', true, 'post', { goodsId: goodsId, propertyChildIds: propertyChildIds });
  },
